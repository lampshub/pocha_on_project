...
public class CategoryController {
    ...
    //    메뉴 카테고리 추가
    @PostMapping("/create")
    public ResponseEntity<?> createCategory(@RequestBody CategoryReqDto reqDto) {
    ...
    public ResponseEntity<?> updateCategory(@PathVariable("categoryid") Long categoryId, @RequestBody CategoryReqDto reqDto) {

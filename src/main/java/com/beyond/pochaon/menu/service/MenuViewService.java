...
public class MenuViewService {
    ...
    @Autowired
    public MenuViewService(MenuRepository menuRepository, CategoryRepository categoryRepository, HttpServletRequest request, MenuOptionRepository menuOptionRepository) {
    ...
    public MenuDetailPageDto findMenuDetail(Long menuId) throws AccessDeniedException {
        ...
        menuOptionRepository.fetchOptionDetailsForMenu(menuId);
    ...
    public List<CategoryViewDto> findAllCategory() throws AccessDeniedException {
        ...
        List<Category> categoryList = categoryRepository.findByStoreIdWithMenus(storeId);
